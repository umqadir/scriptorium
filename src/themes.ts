// Theme palettes lifted from Monkeytype (GPL-3.0).
// Source: monkeytypegame/monkeytype frontend/src/ts/constants/themes.ts
export type Theme = {
  hasCss?: boolean;
  bg: string; main: string; caret: string; sub: string; subAlt: string;
  text: string; error: string; errorExtra: string;
  colorfulError: string; colorfulErrorExtra: string;
};
